...
| **Migrasi 0011 dijalankan di Supabase produksi** | ✅ output produksi fleksibel — bahan tanpa resep = output langsung tanpa konsumsi diri. Diverifikasi live 14 Sep: `ingredient_needs(Ayam Potong 9, 5)` → 0 baris ✅; kontrol beresep (Sambal Geprek Cup) tetap hitung kebutuhan ✅. Selaras dgn frontend, demo, dan panel "Produksi Cepat" (templat 1 klik) |
